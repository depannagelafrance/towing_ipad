//
//  AllotmentDirectionIndicatorTableViewController.m
//  towing
//
...
@implementation AllotmentDirectionIndicatorTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = ((AllotmentDirectionIndicator *)[self.data objectAtIndex:indexPath.row]).name;
