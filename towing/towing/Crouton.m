...
+ (Crouton *) pleaseWait:(NSString *) message inView:(UIView *) currentView {
    ...
    CGFloat screenWidth = inLandscape ? [UIScreen mainScreen].bounds.size.width : [UIScreen mainScreen].bounds.size.height;
    CGFloat screenHeight = inLandscape ? [UIScreen mainScreen].bounds.size.height : [UIScreen mainScreen].bounds.size.width;
