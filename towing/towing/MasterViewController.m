...
- (UITableViewCell *) configureCellAtIndexPath:(NSIndexPath *)indexPath {
    Dossier *dossier = (Dossier *) [self.fetchedResultsController objectAtIndexPath:indexPath];
    ...
    cell.numberLabel.text = dossier.dossier_number;
    cell.callDateLabel.text = [DateUtil formatAsDateTime:dossier.call_date];
    cell.direction.text = @"direction";
    cell.indicator.text = @"indicator";
    cell.vehiculeType.text = @"indicator";
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:DOSSIER_ENTITY inManagedObjectContext:self.managedObjectContext];
